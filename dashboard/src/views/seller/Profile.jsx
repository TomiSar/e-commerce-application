          ...
          <div className='w-full p-4 bg-[#6a5fdf] rounded-md text-[#d0d2d6]'>
            <div className='flex justify-center items-center py-3'>
              {userInfo?.image ? (
                ...
                <label
                  className='flex justify-center items-center flex-col h-[150px] w-[200px] cursor-pointer border border-dashed hover:border-slate-950 border-[#d0d2d6] relative'
                  htmlFor='img'
                >
                  <span>
                    <FaImages />{' '}
            ...
            <div className='px-0 md:px-5 py-2'>
              {!userInfo?.shopInfo ? (
                <form onSubmit={add}>
                  ...
                  <button
                    className='bg-slate-900 w-[200px] hover:shadow-blue-300 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3 my-3'
          ...
          <div className='w-full pl-0 md:pl-7 mt-6 md:mt-0'>
            <div className='bg-[#6a5fdf] rounded-md text-[#d0d2d6] p-4'>
              ...
              <form>
                ...
                <button className='bg-blue-700 w-[180px] hover:shadow-blue-300/40 hover:shadow-lg text-white rounded-md px-7 py-2 my-3'>
                  Save Changes
                </button>
              </form>
            </div>
